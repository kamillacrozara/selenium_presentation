...
Description:    
    This test searches for different values in the max number  
...
"""This class executes tests with the max value of files field 
...
class  NumFilesMaxValueLightTest(unittest.TestCase):
    ...
    """This method verifies the results of searchers for 
       values from 0 and 11 int the max field"""
