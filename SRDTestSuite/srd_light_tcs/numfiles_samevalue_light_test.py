...
Description:    
    This test searches for same values in the min and max number  
...
"""This class executes tests with the same value in the min
    and max value of files fields on Source Code Search tab"""
class  NumFilesSameValueLightTest(unittest.TestCase):
    ...
    """This method verifies the results of searchers for 
       the same values to min and max field"""
