...
# -*- coding: utf-8 *-*
"""
File: srd_sd_numfiles_maxvalue_sourcecodesearchtab_test.py
Author: Kamilla H. Crozara
Description:    
    This tests verifies the searches different values in the max number 
...
class SrdSdNumfilesMaxValueSourceCodeSearchtabTc(unittest.TestCase):
    def setUp(self):
